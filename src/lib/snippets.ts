...
export function instrucaoParaClaudeCode(opcoes: {
  ...
  const linhas = [
    ...
    `   Em Pages Router, pages/_document.tsx. Numa SPA com Vite (React, Vue, Svelte), no index.html`,
    `   da raiz — nunca dentro de um componente. Em WordPress, o cabeçalho global do tema ou um`,
